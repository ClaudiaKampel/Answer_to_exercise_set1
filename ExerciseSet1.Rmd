...
author: "T. Evgeniou / Pedro Barbosa Franco"
...
**Your Answers here:**
<br>
1. [1] "\nDownloading ticker  AAPL  ..." - Its in the dataSet1.R file, on the "my tickers" section;
<br>
2. a. round(100*sum(AAPL),1) - 596.4%;
<br>
2. b. round(100*sd(StockReturns[,2]),3) - 2.39%;
<br>
3. mytickers = c("SPY", "AAPL", "YHOO") (in the dataSet1.R) - By including the YHOO ticker;
<br>
...
**Your Answers here:**
1. 2001-01-01 is a non trading day, so by chaning the sourcing date in dataSet1.R, line 9 to startDate = "2000-12-29" we get the data to start on the 02 of January.;
2. By adding more companies to line 8 (mytickers = c("SPY", "AAPL", "YHOO", "GOOG") ) and adjusting the portfolio (using the mean function), we can plot an equally weighted portfolio.;
...
**Your Answers here:**
<br>
1) The command returns 20 (the number of days);
<br>
